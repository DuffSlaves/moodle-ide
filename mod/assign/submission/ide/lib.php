...
function assignsubmission_ide_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload)
{
    global $DB, $CFG;
    ...
    $fullpath = "/{$context->id}/assignsubmission_ide/$filearea/$itemid/$relativepath";
